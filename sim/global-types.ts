...
declare namespace TierTypes {
    export type Singles = "ELEON Uber" | "AG" | "Uber" | "(Uber)" | "ELEON" | "OU" | "(OU)" | "UUBL" | "UU" | "RUBL" | "RU" | "NUBL" | "NU" |
        "(NU)" | "PUBL" | "PU" | "(PU)" | "ZUBL" | "ZU" | "NFE" | "LC";
    export type Doubles = "ELEON Uber" | "EUber" | "(EUber)" | "ELEON" | "ELEONOU" | "(ELEONOU)" | "ELEONBL" | "ELEONUU" | "(ELEONUU)" | "NFE" | "LC";
